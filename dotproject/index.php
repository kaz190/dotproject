...
if( is_file( DP_BASE_DIR . '/includes/config.php' ) ) {
	...
	echo '<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="refresh" content="5; URL='.DP_BASE_URL.'/install/index-ja.php"></head><body>';
	//echo 'Fatal Error. You haven\'t created a config file yet.<br/><a href="./install/index.php">'
	//  .'Click Here To Start Installation and Create One!</a> (forwarded in 5 sec.[Japanese])';
	echo '致命的なエラーが発生しました。まだコンフィグファイルが存在しません。<br/><a href="./install/index-ja.php">'
	  .'ここをクリックするとインストールとコンフィグファイルの作成を行います。</a> (5秒後にインストール画面に移動)<br/>';
	echo '</body></html>';
	exit();
}
