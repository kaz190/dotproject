...
//$pdf->SetAuthor();
$pdf->SetTitle($AppUI->_('Project Upcoming Task Report'));
...
//set margins
$pdf->SetMargins(PDF_MARGIN_LEFT, $y_start, PDF_MARGIN_RIGHT);
...
// Title 
$slen = mb_strlen($AppUI->_('Project Upcoming Task Report')) + $str_pad;
$pdf->writeHTMLCell($header_w + $slen, $header_h, $x, $y,$AppUI->_('Project Upcoming Task Report'));
