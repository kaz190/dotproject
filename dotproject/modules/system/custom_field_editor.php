  ...
  die('You should not access this file directly.');
	...
	foreach ($modules as $module)
	{
		...
		foreach ($custom_fields as $f)
		{
			...
			echo "<a href=\"?m=system&a=custom_field_addedit&module=".$module["mod_name"]."&field_id=".$f["field_id"]."\"><img src='./images/icons/stock_edit-16.png' align='center' width='16' height='16' border='0'>".$AppUI->_('Edit')."</a>";
			echo "</td>\n<td class=\"hilite\">";
			echo "<a href=\"?m=system&a=custom_field_addedit&field_id=".$f["field_id"]."&delete=1\"><img src='./images/icons/stock_delete-16.png' align='center' width='16' height='16' border='0'>".$AppUI->_('Delete')."</a> ";
			echo "</td>\n<td class=\"hilite\">";
