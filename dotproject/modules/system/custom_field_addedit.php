...
<table class="std" align="center" width="100%">
	<th colspan="2">
	...
	<tr><td colspan="2" align="right">
		<input type="button" value="<?php echo $AppUI->_('Cancel'); ?>" onClick="location = '?m=system&a=custom_field_editor';" />
		<input type="button" value="<?php echo $AppUI->_('Save'); ?>" onClick="javascript:postCustomField()" />
	</td></tr>
	</form>
</table>
